...
class ZaiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_depan_zai, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.za_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.za_syair_audio)

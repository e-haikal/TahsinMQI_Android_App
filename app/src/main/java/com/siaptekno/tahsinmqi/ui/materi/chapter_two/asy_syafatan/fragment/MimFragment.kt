...
class MimFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_asysyafatan_mim, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ma_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ma_syair_audio)

package com.siaptekno.tahsinmqi.ui.materi.chapter_two.al_lisan_belakang.fragment
...
class QofFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_belakang_qof, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.qa_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.qa_syair_audio)

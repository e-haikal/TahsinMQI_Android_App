...
class NunFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_tengah_nun, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.na_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.na_syair_audio)

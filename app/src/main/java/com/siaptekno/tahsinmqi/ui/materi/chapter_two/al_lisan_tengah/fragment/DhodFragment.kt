...
class DhodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_tengah_dhod, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.dho_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.dho_syair_audio)

...
class BaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_asysyafatan_ba, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ba_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ba_syair_audio)

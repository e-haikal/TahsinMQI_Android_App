...
class ShodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_depan_shod, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.sho_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.sho_syair_audio)

...
class TidakBerlawananFragment : Fragment() {

    // Binding for the fragment's layout. Nullable to handle lifecycle management properly.
    private var _binding : ItemMateriSifatTidakBerlawananBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ItemMateriSifatTidakBerlawananBinding.inflate(inflater, container, false)
        return binding.root
    }

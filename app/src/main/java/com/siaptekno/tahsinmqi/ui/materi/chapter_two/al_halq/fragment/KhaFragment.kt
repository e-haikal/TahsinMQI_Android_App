...
class KhaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_alhalq_kha, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.kha_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.kha_syair_audio)

...
class HaKecilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_alhalq_ha_kecil, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ha_kecil_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ha_kecil_syair_audio)

...
class AinFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_alhalq_ain, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ain_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ain_syair_audio)

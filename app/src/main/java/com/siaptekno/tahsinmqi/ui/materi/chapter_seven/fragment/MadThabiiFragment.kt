...
class MadThabiiFragment : Fragment() {

    // Binding for the fragment's layout. Nullable to handle lifecycle management properly.
    private var _binding : ItemMateriMadThabiiBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ItemMateriMadThabiiBinding.inflate(inflater, container, false)
        return binding.root
    }

...
class KafFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_belakang_kaf, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ka_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ka_syair_audio)

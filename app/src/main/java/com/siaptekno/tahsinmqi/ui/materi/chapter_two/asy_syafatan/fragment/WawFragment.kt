package com.siaptekno.tahsinmqi.ui.materi.chapter_two.asy_syafatan.fragment
...
class WawFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_asysyafatan_waw, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.wa_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.wa_syair_audio)

    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = MaterialAdapter(materials) { material ->
            ...
            when (material.id) {
                ...
                4 -> findNavController().navigate(R.id.action_materialFragment_to_MaterialChapterFourFragment)
                ...
                11 -> findNavController().navigate(R.id.action_materialFragment_to_MaterialChapterElevenFragment)

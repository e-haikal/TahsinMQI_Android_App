...
class GhainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_alhalq_ghain, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ghain_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ghain_syair_audio)

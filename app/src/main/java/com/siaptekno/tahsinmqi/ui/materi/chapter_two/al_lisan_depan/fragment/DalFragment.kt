...
class DalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_depan_dal, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.da_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.da_syair_audio)

...
class RoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_tengah_ro, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.ra_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.ra_syair_audio)

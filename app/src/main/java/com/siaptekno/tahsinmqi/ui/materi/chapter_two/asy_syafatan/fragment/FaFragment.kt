...
class FaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_asysyafatan_fa, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.fa_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.fa_syair_audio)

...
class DzalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_depan_dzal, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.dza_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.dza_syair_audio)

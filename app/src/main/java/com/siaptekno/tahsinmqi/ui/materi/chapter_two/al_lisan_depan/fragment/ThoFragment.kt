...
class ThoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.item_materi_lisan_depan_tho, container, false)
        ...
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.tho_audio)
        mediaPlayer2 = MediaPlayer.create(requireContext(), R.raw.tho_syair_audio)
